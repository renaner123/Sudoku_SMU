...
function newBoard(){ // joga matrix para interface, no caso, uma matrix para ser resolvida,
    ...
    var url = "https://sudokusmu.herokuapp.com/startNewGame";//Sua URL
...
function checkBoard(){ //Verificar se o que o usuário enviar no solve está correto   
    ...
    var url = "https://sudokusmu.herokuapp.com/checkSolution";//Sua URL
...
function listUri(){
    ...
    var url = "https://sudokusmu.herokuapp.com/listUri";//Sua URL
